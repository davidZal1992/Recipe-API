...
export let optionsCuisine=[
    { value: "", text: 'Please Choose Cousine' },
    ...
    export let optionsDiet=[
        { value: "", text: 'Please Choose Diet' },
    ...
    export let optionsIntolerances=[
        { value: "", text: 'Please Choose Intolerances' },
